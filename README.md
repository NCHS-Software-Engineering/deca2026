...
Server: This handles the connection to the server. Every time data is needed from the database or is needed to be added to the database the server handles the actual mysql calls and sends it to the JSX of the page you are making which must have code to receive the post.
