...
"[project]/my-react-app/node_modules/next/dist/build/polyfills/process.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
module.exports = ((_global_process = /*TURBOPACK member replacement*/ __turbopack_context__.g.process) == null ? void 0 : _global_process.env) && _type_of._((_global_process1 = /*TURBOPACK member replacement*/ __turbopack_context__.g.process) == null ? void 0 : _global_process1.env) === 'object' ? /*TURBOPACK member replacement*/ __turbopack_context__.g.process : __turbopack_context__.r("[project]/my-react-app/node_modules/next/dist/compiled/process/browser.js [client] (ecmascript)"); //# sourceMappingURL=process.js.map
}),
"[project]/my-react-app/node_modules/next/dist/build/polyfills/polyfill-module.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/my-react-app/node_modules/next/dist/build/deployment-id.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/my-react-app/node_modules/next/dist/lib/route-pattern-normalizer.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
_export(exports, {
    PARAM_SEPARATOR: function PARAM_SEPARATOR1() {
        return PARAM_SEPARATOR;
    },
    hasAdjacentParameterIssues: function hasAdjacentParameterIssues1() {
        return hasAdjacentParameterIssues;
    },
    normalizeAdjacentParameters: function normalizeAdjacentParameters1() {
        return normalizeAdjacentParameters;
    },
    normalizeTokensForRegexp: function normalizeTokensForRegexp1() {
        return normalizeTokensForRegexp;
    },
    stripNormalizedSeparators: function stripNormalizedSeparators1() {
        return stripNormalizedSeparators;
    },
    stripParameterSeparators: function stripParameterSeparators1() {
...
function normalizeTokensForRegexp(tokens) {
    return tokens.map(function(token) {
        ...
        if ((typeof token === "undefined" ? "undefined" : _type_of._(token)) === 'object' && token !== null && // Not all token objects have 'modifier' property (e.g., simple text tokens)
        ...
        token.prefix === '' && token.suffix === '') {
            ...
            return _object_spread_props._(_object_spread._({}, token), {
                prefix: '/'
            });
        }
        return token;
...
function stripNormalizedSeparators(pathname) {
    ...
    return pathname.replace(new RegExp("\\)".concat(PARAM_SEPARATOR), 'g'), ')');
}
        ...
        for(var _iterator = Object.entries(params)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
            ...
            if (typeof value === 'string') {
                ...
                cleaned[key] = value.map(function(item) {
                    return typeof item === 'string' ? item.replace(new RegExp("^".concat(PARAM_SEPARATOR)), '') : item;
                });
            } else {
                cleaned[key] = value;
            }
...
"[project]/my-react-app/node_modules/next/dist/lib/constants.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/my-react-app/node_modules/next/dist/lib/is-error.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var _isplainobject = __turbopack_context__.r("[project]/my-react-app/node_modules/next/dist/shared/lib/is-plain-object.js [client] (ecmascript)");
/**
...
"[project]/my-react-app/node_modules/next/dist/lib/is-api-route.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/my-react-app/node_modules/next/dist/lib/require-instrumentation-client.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/my-react-app/node_modules/next/dist/next-devtools/userspace/app/errors/stitched-error.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/my-react-app/node_modules/next/dist/next-devtools/shared/react-18-hydration-error.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
_export(exports, {
    getHydrationWarningType: function getHydrationWarningType1() {
        return getHydrationWarningType;
    },
    isHydrationError: function isHydrationError1() {
        return isHydrationError;
    },
    isHydrationWarning: function isHydrationWarning1() {
...
var htmlTagsWarnings = new Set([
    'Warning: Expected server HTML to contain a matching <%s> in <%s>.%s',
    'Warning: Did not expect server HTML to contain a <%s> in <%s>.%s'
]);
var textAndTagsMismatchWarnings = new Set([
    'Warning: Expected server HTML to contain a matching text node for "%s" in <%s>.%s',
    'Warning: Did not expect server HTML to contain the text node "%s" in <%s>.%s'
]);
var textWarnings = new Set([
    'Warning: Text content did not match. Server: "%s" Client: "%s"%s'
]);
var getHydrationWarningType = function(message) {
    if (typeof message !== 'string') {
        // TODO: Doesn't make sense to treat no message as a hydration error message.
        // We should bail out somewhere earlier.
        return 'text';
    }
    var normalizedMessage = message.startsWith('Warning: ') ? message : "Warning: ".concat(message);
    if (isHtmlTagsWarning(normalizedMessage)) return 'tag';
    if (isTextInTagsMismatchWarning(normalizedMessage)) return 'text-in-tag';
    return 'text';
};
var isHtmlTagsWarning = function(message) {
    return typeof message === 'string' && htmlTagsWarnings.has(message);
};
var isTextInTagsMismatchWarning = function(msg) {
    return typeof msg === 'string' && textAndTagsMismatchWarnings.has(msg);
};
var isTextWarning = function(msg) {
    return typeof msg === 'string' && textWarnings.has(msg);
};
if ((typeof exports["default"] === 'function' || _type_of._(exports["default"]) === 'object' && exports["default"] !== null) && typeof exports["default"].__esModule === 'undefined') {
    Object.defineProperty(exports["default"], '__esModule', {
        value: true
...
"[project]/my-react-app/node_modules/next/dist/next-devtools/shared/react-19-hydration-error.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

var _sliced_to_array = __turbopack_context__.r("[project]/my-react-app/node_modules/@swc/helpers/cjs/_sliced_to_array.cjs [client] (ecmascript)");
var _to_array = __turbopack_context__.r("[project]/my-react-app/node_modules/@swc/helpers/cjs/_to_array.cjs [client] (ecmascript)");
var _type_of = __turbopack_context__.r("[project]/my-react-app/node_modules/@swc/helpers/cjs/_type_of.cjs [client] (ecmascript)");
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
_export(exports, {
    NEXTJS_HYDRATION_ERROR_LINK: function NEXTJS_HYDRATION_ERROR_LINK1() {
        return NEXTJS_HYDRATION_ERROR_LINK;
    },
    REACT_HYDRATION_ERROR_LINK: function REACT_HYDRATION_ERROR_LINK1() {
        return REACT_HYDRATION_ERROR_LINK;
    },
    getHydrationErrorStackInfo: function getHydrationErrorStackInfo1() {
        return getHydrationErrorStackInfo;
    },
    isErrorMessageWithComponentStackDiff: function isErrorMessageWithComponentStackDiff1() {
...
var REACT_HYDRATION_ERROR_LINK = 'https://react.dev/link/hydration-mismatch';
var NEXTJS_HYDRATION_ERROR_LINK = 'https://nextjs.org/docs/messages/react-hydration-error';
/**
 * Only React 19+ contains component stack diff in the error message
 */ var errorMessagesWithComponentStackDiff = [
...
function isErrorMessageWithComponentStackDiff(msg) {
    return errorMessagesWithComponentStackDiff.some(function(regex) {
...
function getHydrationErrorStackInfo(error) {
    ...
    if (isErrorMessageWithComponentStackDiff(errorMessage)) {
        var _errorMessage_split = _sliced_to_array._(errorMessage.split('\n\n'), 2), message = _errorMessage_split[0], tmp = _errorMessage_split[1], diffLog = tmp === void 0 ? '' : tmp;
        var diff = diffLog.trim();
        return {
    ...
    var _errorMessage_split1 = _sliced_to_array._(errorMessage.split("".concat(REACT_HYDRATION_ERROR_LINK)), 2), message1 = _errorMessage_split1[0], maybeComponentStackDiff = _errorMessage_split1[1];
    var trimmedMessage = message1.trim();
    ...
    if (maybeComponentStackDiff !== undefined && maybeComponentStackDiff.length > 1) {
        ...
        var _trimmedMessage_split = _to_array._(trimmedMessage.split('\n\n')), displayedMessage = _trimmedMessage_split[0], notes = _trimmedMessage_split.slice(1);
        return {
        ...
        var _trimmedMessage_split1 = _to_array._(trimmedMessage.split('\n\n')), displayedMessage1 = _trimmedMessage_split1[0], notes1 = _trimmedMessage_split1.slice(1);
        return {
            message: displayedMessage1,
            diff: null,
            notes: notes1.join('\n\n')
        };
    }
...
"[project]/my-react-app/node_modules/next/dist/next-devtools/userspace/pages/hydration-error-state.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
_export(exports, {
    attachHydrationErrorState: function attachHydrationErrorState1() {
        return attachHydrationErrorState;
    },
    getSquashedHydrationErrorDetails: function getSquashedHydrationErrorDetails1() {
        return getSquashedHydrationErrorDetails;
    },
    storeHydrationErrorStateFromConsoleArgs: function storeHydrationErrorStateFromConsoleArgs1() {
        return storeHydrationErrorStateFromConsoleArgs;
    }
});
var _react18hydrationerror = __turbopack_context__.r("[project]/my-react-app/node_modules/next/dist/next-devtools/shared/react-18-hydration-error.js [client] (ecmascript)");
var _react19hydrationerror = __turbopack_context__.r("[project]/my-react-app/node_modules/next/dist/next-devtools/shared/react-19-hydration-error.js [client] (ecmascript)");
...
var hydrationErrorState = {};
var squashedHydrationErrorDetails = new WeakMap();
...
function attachHydrationErrorState(error) {
    ...
    var parsedHydrationErrorState = {};
    // If there's any extra information in the error message to display,
    // append it to the error message details property
    if (hydrationErrorState.warning) {
        // The patched console.error found hydration errors logged by React
        // Append the logged warning to the error message
        parsedHydrationErrorState = _object_spread._({}, hydrationErrorState);
...
function storeHydrationErrorStateFromConsoleArgs() {
    ...
    var _args = _to_array._(args), message = _args[0], firstContent = _args[1], secondContent = _args[2], rest = _args.slice(3);
    if ((0, _react18hydrationerror.isHydrationWarning)(message)) {
        ...
        var warning = message.replace(/Warning: /, '').replace('%s', firstContent).replace('%s', secondContent) // remove the last %s from the message
        .replace(/%s/g, '');
        var lastArg = (rest[rest.length - 1] || '').trim();
        ...
        var warning1 = message.replace('%s', firstContent).replace('%s', secondContent) // remove the last %s from the message
        .replace(/%s/g, '');
        var lastArg1 = (args[args.length - 1] || '').trim();
        hydrationErrorState.reactOutputComponentDiff = lastArg1;
        hydrationErrorState.warning = warning1;
    }
}
/*
 ...
 */ function generateHydrationDiffReact18(message, firstContent, secondContent, lastArg) {
    var componentStack = lastArg;
    var firstIndex = -1;
    var secondIndex = -1;
    var hydrationWarningType = (0, _react18hydrationerror.getHydrationWarningType)(message);
    // at div\n at Foo\n at Bar (....)\n -> [div, Foo]
    var components = componentStack.split('\n') // .reverse()
    .map(function(line, index) {
        // `<space>at <component> (<location>)` -> `at <component> (<location>)`
        line = line.trim();
        // extract `<space>at <component>` to `<<component>>`
        // e.g. `  at Foo` -> `<Foo>`
        var _ref = _sliced_to_array._(/at (\w+)( \((.*)\))?/.exec(line) || [], 3), component = _ref[1], location = _ref[2];
    ...
    for(var i = 0; i < components.length; i++){
        ...
        var matchFirstContent = hydrationWarningType === 'tag' && i === components.length - firstIndex - 1;
        var matchSecondContent = hydrationWarningType === 'tag' && i === components.length - secondIndex - 1;
        if (matchFirstContent || matchSecondContent) {
            var spaces = ' '.repeat(Math.max(i * 2 - 2, 0) + 2);
            diff += "> ".concat(spaces, "<").concat(component, ">\n");
        } else {
            var spaces1 = ' '.repeat(i * 2 + 2);
            diff += "".concat(spaces1, "<").concat(component, ">\n");
        }
    }
    if (hydrationWarningType === 'text') {
        var spaces2 = ' '.repeat(components.length * 2);
        diff += "+ ".concat(spaces2, '"').concat(firstContent, '"\n');
        diff += "- ".concat(spaces2, '"').concat(secondContent, '"\n');
    } else if (hydrationWarningType === 'text-in-tag') {
        var spaces3 = ' '.repeat(components.length * 2);
        diff += "> ".concat(spaces3, "<").concat(secondContent, ">\n");
        diff += ">   ".concat(spaces3, '"').concat(firstContent, '"\n');
    }
    return diff;
}
if ((typeof exports["default"] === 'function' || _type_of._(exports["default"]) === 'object' && exports["default"] !== null) && typeof exports["default"].__esModule === 'undefined') {
...
"[project]/my-react-app/node_modules/next/dist/next-devtools/userspace/pages/pages-dev-overlay-error-boundary.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var _interop_require_default = __turbopack_context__.r("[project]/my-react-app/node_modules/@swc/helpers/cjs/_interop_require_default.cjs [client] (ecmascript)");
var _react = /*#__PURE__*/ _interop_require_default._(__turbopack_context__.r("[project]/my-react-app/node_modules/react/index.js [client] (ecmascript)"));
var PagesDevOverlayErrorBoundary = /*#__PURE__*/ function(_react_default_PureComponent) {
    _inherits._(PagesDevOverlayErrorBoundary, _react_default_PureComponent);
    function PagesDevOverlayErrorBoundary() {
        for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
            args[_key] = arguments[_key];
        }
        _class_call_check._(this, PagesDevOverlayErrorBoundary);
        var _this;
        _this = _call_super._(this, PagesDevOverlayErrorBoundary, _to_consumable_array._(args)), _this.state = {
            error: null
        };
        return _this;
    }
    _create_class._(PagesDevOverlayErrorBoundary, [
        {
...
"[project]/my-react-app/node_modules/next/dist/next-devtools/userspace/app/terminal-logging-config.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/my-react-app/node_modules/next/dist/next-devtools/shared/forward-logs-shared.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/my-react-app/node_modules/next/dist/next-devtools/userspace/app/forward-logs-utils.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var _safestablestringify = __turbopack_context__.r("[project]/my-react-app/node_modules/next/dist/compiled/safe-stable-stringify/index.js [client] (ecmascript)");
var _terminalloggingconfig = __turbopack_context__.r("[project]/my-react-app/node_modules/next/dist/next-devtools/userspace/app/terminal-logging-config.js [client] (ecmascript)");
var _forwardlogsshared = __turbopack_context__.r("[project]/my-react-app/node_modules/next/dist/next-devtools/shared/forward-logs-shared.js [client] (ecmascript)");
...
"[project]/my-react-app/node_modules/next/dist/next-devtools/userspace/app/forward-logs.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var _stitchederror = __turbopack_context__.r("[project]/my-react-app/node_modules/next/dist/next-devtools/userspace/app/errors/stitched-error.js [client] (ecmascript)");
var _errorsource = __turbopack_context__.r("[project]/my-react-app/node_modules/next/dist/shared/lib/error-source.js [client] (ecmascript)");
var _terminalloggingconfig = __turbopack_context__.r("[project]/my-react-app/node_modules/next/dist/next-devtools/userspace/app/terminal-logging-config.js [client] (ecmascript)");
var _forwardlogsshared = __turbopack_context__.r("[project]/my-react-app/node_modules/next/dist/next-devtools/shared/forward-logs-shared.js [client] (ecmascript)");
var _forwardlogsutils = __turbopack_context__.r("[project]/my-react-app/node_modules/next/dist/next-devtools/userspace/app/forward-logs-utils.js [client] (ecmascript)");
...
"[project]/my-react-app/node_modules/next/dist/next-devtools/userspace/pages/pages-dev-overlay-setup.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
_export(exports, {
    PagesDevOverlayBridge: function PagesDevOverlayBridge1() {
        return PagesDevOverlayBridge;
    },
    register: function register1() {
        return register;
    }
});
var _interop_require_default = __turbopack_context__.r("[project]/my-react-app/node_modules/@swc/helpers/cjs/_interop_require_default.cjs [client] (ecmascript)");
...
var _hydrationerrorstate = __turbopack_context__.r("[project]/my-react-app/node_modules/next/dist/next-devtools/userspace/pages/hydration-error-state.js [client] (ecmascript)");
...
var _pagesdevoverlayerrorboundary = __turbopack_context__.r("[project]/my-react-app/node_modules/next/dist/next-devtools/userspace/pages/pages-dev-overlay-error-boundary.js [client] (ecmascript)");
...
var usePagesDevOverlayBridge = function() {
    _react["default"].useInsertionEffect({
        "usePagesDevOverlayBridge.useInsertionEffect": function() {
    ...
    _react["default"].useEffect({
        "usePagesDevOverlayBridge.useEffect": function() {
            var handleStaticIndicator = __turbopack_context__.r("[project]/my-react-app/node_modules/next/dist/client/dev/hot-reloader/pages/hot-reloader-pages.js [client] (ecmascript)").handleStaticIndicator;
...
function handleError(error) {
    if (!error || !_instanceof._(error, Error) || typeof error.stack !== 'string') {
...
function nextJsHandleConsoleError() {
    ...
    var maybeError = ("TURBOPACK compile-time truthy", 1) ? args[1] : "TURBOPACK unreachable";
    (0, _hydrationerrorstate.storeHydrationErrorStateFromConsoleArgs).apply(this, _to_consumable_array._(args));
...
function onUnhandledError(event) {
    var error = event === null || event === void 0 ? void 0 : event.error;
    handleError(error);
    if (error) {
...
function onUnhandledRejection(ev) {
    ...
    if (!reason || !_instanceof._(reason, Error) || typeof reason.stack !== 'string') {
        // A non-error was thrown, we don't have anything to show. :-(
        return;
    }
...
"[project]/my-react-app/node_modules/next/dist/server/dev/hot-reloader-types.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/my-react-app/node_modules/next/dist/server/dev/node-stack-frames.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var _stacktraceparser = __turbopack_context__.r("[project]/my-react-app/node_modules/next/dist/compiled/stacktrace-parser/stack-trace-parser.cjs.js [client] (ecmascript)");
var _errorsource = __turbopack_context__.r("[project]/my-react-app/node_modules/next/dist/shared/lib/error-source.js [client] (ecmascript)");
function getFilesystemFrame(frame) {
    var f = _object_spread._({}, frame);
...
function getServerError(error, type) {
    if (error.name === 'TurbopackInternalError') {
        ...
        var turbopackInternalError = Object.defineProperty(new Error('An unexpected Turbopack error occurred. Please see the output of `next dev` for more details.'), "__NEXT_ERROR_CODE", {
            value: "E167",
            enumerable: false,
            configurable: true
        });
    ...
    n.name = error.name;
    try {
        n.stack = "".concat(n.toString(), "\n").concat((0, _stacktraceparser.parse)(error.stack).map(getFilesystemFrame).map(function(f) {
            var str = "    at ".concat(f.methodName);
            if (f.file) {
                var loc = f.file;
                if (f.lineNumber) {
...
"[project]/my-react-app/node_modules/next/dist/server/request-meta.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/my-react-app/node_modules/next/dist/pages/_error.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var _jsxruntime = __turbopack_context__.r("[project]/my-react-app/node_modules/react/jsx-runtime.js [client] (ecmascript)");
var _react = /*#__PURE__*/ _interop_require_default._(__turbopack_context__.r("[project]/my-react-app/node_modules/react/index.js [client] (ecmascript)"));
var _head = /*#__PURE__*/ _interop_require_default._(__turbopack_context__.r("[project]/my-react-app/node_modules/next/dist/shared/lib/head.js [client] (ecmascript)"));
var statusCodes = {
    400: 'Bad Request',
...
function _getInitialProps(param) {
    ...
    if (typeof window !== 'undefined') {
        ...
        var getRequestMeta = __turbopack_context__.r("[project]/my-react-app/node_modules/next/dist/server/request-meta.js [client] (ecmascript)").getRequestMeta;
...
//# sourceMappingURL=a50e4_next_dist_ea21c6e6._.js.map